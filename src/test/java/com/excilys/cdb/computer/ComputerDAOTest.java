...
public class ComputerDAOTest {
    ...
    public void testCreateFindDelete() throws DAOException {
        ...
        final Computer comp = new Computer.ComputerBuilder()
                .name("MyComputerName").discontinued(LocalDate.now()).build();
    ...
    public void testUpdate() throws DAOException {
        ...
        final Computer comp = new Computer.ComputerBuilder()
                .name("MyComputerName").discontinued(d1).build();
    ...
    public void testFindAllWithLimit1() throws DAOException {
        final List<Computer> computers1 = this.computerDAO.findAll(0, 20);
        final List<Computer> computers2 = this.computerDAO.findAll();
    ...
    public void testFindAllWithLimit2() throws DAOException {
        final List<Computer> computers1 = this.computerDAO.findAll(20, 7);
        final List<Computer> computers2 = this.computerDAO.findAll();
