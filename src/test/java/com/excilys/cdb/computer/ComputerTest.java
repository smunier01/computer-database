...
public class ComputerTest {
    ...
    public void testBuilder() {
        ...
        Computer comp = (new Computer.ComputerBuilder()).id(1L).build();
    ...
    public void testEquals() {
        ...
        Computer a = (new Computer.ComputerBuilder()).id(1L).name("MyComputerName").introduced(d1).discontinued(d2)
                .company(company).build();

        Computer b = (new Computer.ComputerBuilder()).id(1L).name("MyComputerName").introduced(d1).discontinued(d2)
                .company(company).build();
