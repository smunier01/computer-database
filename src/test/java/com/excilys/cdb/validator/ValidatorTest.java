...
import com.excilys.cdb.validation.ValidatorBool;

public class ValidatorTest {

    private final ValidatorBool v = ValidatorBool.getInstance();

    @Test
    public void testValidateIntAllTrue() {
        final Stream<String> s = Stream.of("1", "01", "15480", "0002", "0088471598154000");

        final boolean a = s.allMatch(this.v::validateInt);
    ...
    public void testValidateIntAllFalse() {
        ...
        final boolean a = s.anyMatch(this.v::validateInt);
    ...
    public void testValidateDateAllTrue() {
        ...
        final boolean a = s.allMatch(this.v::validateDate);
    ...
    public void testValidateDateAllFalse() {
        ...
        final boolean a = s.anyMatch(this.v::validateDate);
